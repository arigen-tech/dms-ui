...
const protectedRoutes = [
  ...
  { path: "/total-approved", element: <ApproveByAdmin />, allowedRoles: [ADMIN,BRANCH_ADMIN,DEPARTMENT_ADMIN] },
  { path: "/total-rejected", element: <RejectByAdmin />, allowedRoles: [ADMIN,BRANCH_ADMIN,DEPARTMENT_ADMIN] },
