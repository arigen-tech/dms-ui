            ...
            <div className="form-group ">
                {editingBranchId === null ? (
                  <button
                    ...
                    className={`btn-primary bg-blue-900- text-white- rounded-2xl- p-2- w-full- text-sm- flex- items-center- justify-center- ${isSubmitting ? 'opacity-50- cursor-not-allowed-' : ''}`}
                  >
                    {isSubmitting ? (
