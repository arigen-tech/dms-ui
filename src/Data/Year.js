            ...
            <tbody>
              {paginatedYears.map((year, index) => (
                <tr key={year.id}>
                  ...
                  <td className='text-center'>{year.name}</td>
                  <td>{formatDate(year.createdOn)}</td>
                  <td>{formatDate(year.updatedOn)}</td>
                  <td>
                  ...
                  <td className='text-center'>
                    <div className='btn-center'>
                      <button
                        ...
                        className={`viewBtn ${!year.isActive ? 'opacity-50 cursor-not-allowed' : ''}`}>
                        <PencilIcon />
                      </button>
                    </div>
                  </td>
