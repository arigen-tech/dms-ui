...
const DocumentTrashReport = () => {
    ...
    return (
        <div className="p-4-">
            <div className="title">
                <h1><AutoTranslate>Trash Reports</AutoTranslate></h1>
            </div>
            ...
            <div className="card mb-6">
                <div className="cardLight">
                    <div className="grid grid-col-4 mb-4">
                        ...
                        {/* Action Type */}
                        <div className="form-group">
                            <label><AutoTranslate>Action Type</AutoTranslate></label>
                            <select
                                name="actionType"
                            ...
                            <tbody>
                                {searchResults.map((item) => (
                                    <tr key={item.reportId}>
                                        ...
                                        <td>{item.category}</td>
                                        <td>{item.version}</td>
                                        <td>{getActionTypeDisplay(item.actionType)}</td>
                                        <td>{formatDate(item.actionDate)}</td>
                                        <td>{item.actionBy}</td>
                                    </tr>
                                ))}
                            </tbody>
